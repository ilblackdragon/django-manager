...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('auth_ext_emailconfirmation', (
        ...
        db.send_create_signal('auth_ext', ['EmailConfirmation'])

        # Adding model 'Profile'
        db.create_table('auth_ext_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('language', self.gf('django.db.models.fields.CharField')(default='ru', max_length=10)),
            ('middle_name', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True)),
            ('email_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('auth_ext', ['Profile'])


    def backwards(self, orm):
        
        # Deleting model 'EmailConfirmation'
        db.delete_table('auth_ext_emailconfirmation')

        # Deleting model 'Profile'
        db.delete_table('auth_ext_profile')
